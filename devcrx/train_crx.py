...
#-------------------------------------------
CFG_FILE = '../experiments/siamrpn_r50_l234_dwxcorr/config.yaml'
if os.name == 'nt':
    ...
    cfg.DATASET.COCO.ROOT = '/home/chenrx/GeoData/Benchmark/COCO/crop511'
    cfg.DATASET.COCO.ANNO = '/home/chenrx/GeoData/Benchmark/COCO/crop511/train2017.json'
    
cfg.DATASET.VIDEOS_PER_EPOCH = 60    
...
def train(train_loader, model, optimizer, lr_scheduler, tb_writer):
    ...
    for idx, data in enumerate(train_loader):
        # Save checkpoint and model when a new epoch starts
        if epoch != idx // num_per_epoch + start_epoch:
            ...
            #save model
            torch.save(model.state_dict(), cfg.TRAIN.SNAPSHOT_DIR+'/model_e%d.pth' % (epoch))
        ...
        # Print information and write log
        ...
        if (idx+1) % cfg.TRAIN.PRINT_FREQ == 0:
            info = "Epoch: [{}][{}/{}] lr: {:.6f}\n".format(epoch+1, (idx+1) % num_per_epoch,
